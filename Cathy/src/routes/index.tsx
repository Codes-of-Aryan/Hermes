...
export default function Index() {
  ...
  // // This is a sample text that the assistant can send to the user
  // const specificChatMessage = {
  //   role: "assistant",
  //   content: "Hello customer, I can do this and that",
  // };

  return (
    <App title="Project Hermes">
      <main className="bg-white md:rounded-lg md:shadow-md p-6 w-full h-full flex flex-col">
        <section className="overflow-y-auto flex-grow mb-4 pb-8">
          <div className="flex flex-col space-y-4">
            ...
            {/* Add specific chat message
            {specificChatMessage ? (
              <ChatMessage message={specificChatMessage} />
            ) : null} */}
